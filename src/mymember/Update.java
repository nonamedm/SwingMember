...
public class Update  extends JFrame implements ActionListener{
	...
	public Update(String clickId) {
		init_component();
		MemberProcess mp = new MemberProcess();
		MemberVO      v  = mp.MemberProcess(clickId);
		this.tfId.setText(v.getUserid());
		//this.pfPwd.setText(v.getPasswd()); 비밀번호는 안가져온다
		this.tfName.setText(v.getUsername());
		this.tfTel1.setText(v.getTel1());
		this.tfTel2.setText(v.getTel2());
		this.tfTel3.setText(v.getTel3());
		this.cbJob.setSelectedItem(v.getUserjob());
		//성별은 어떻게하냐
		if(v.getGender().equals("남")) this.rbMan.setSelected(true);
		if(v.getGender().equals("여")) this.rbWoman.setSelected(true);
		this.tfEmail.setText(v.getEmail1());
		this.mailsite.setText(v.getEmail2());
		this.tfIndate.setText(v.getRegdate());
		this.taIntro.setText(v.getUserintro());
	}
...
//		pack();
		...
		pButton.add(ok); pButton.add(cancel); pButton.add(delete);
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "확인" : 
			...
			updateMember(); 
			JOptionPane.showMessageDialog(this, "수정되었습니다");this.dispose();
			break;}
		...
		case "탈퇴" : 
			...
			deleteMember(); 
			JOptionPane.showMessageDialog(this, "삭제되었습니다");this.dispose();
			break;}
		}
